...
export class ProfileViewComponent implements OnInit{
  ...
  this.us_phone = localStorage.getItem("us_phone");
  this.us_phone = this.us_phone?atob(atob(this.us_phone)):"";
  this.us_date_of_joining = localStorage.getItem("us_date_of_joining");
  this.us_date_of_joining = this.user_email?atob(atob(this.us_date_of_joining)):"";
  this.us_id = localStorage.getItem("us_id");
  this.us_id = this.us_id?atob(atob(this.us_id)):"";
  //console.log("this.us_id--------->",this.us_id);
...
showMessage(msg = '', type = 'success') {
  ...
  ngOnInit() {
    ...
    this.systemService.get_userdet().subscribe((rdata: any) => {
      if (rdata.ret_data == 'success') {
          ...
          this.active=rdata.active_tickets
      }
    });
  ...
  edit_profile(){
    ...
    this.router.navigateByUrl('profile-edit/'+btoa(this.us_id));

    // this.systemService.edit_det(this.us_id).subscribe((rdata: any) => {
    //   if (rdata.ret_data == 'success') {
